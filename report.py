...
def question_2():
    ...
    articles on authors.id = articles.author join log on log.path like \
    concat('%',articles.slug,'%') where log.status = '200 OK' and log.method \
    = 'GET' group by authors.name order by views desc;"
    print(question_2)
